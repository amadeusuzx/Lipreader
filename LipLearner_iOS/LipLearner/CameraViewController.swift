            ...
            if let featureVector = self.featureExtraction(modelInput: self.modelInput){
                ...
                case .freeUse:
                    ...
                    DispatchQueue.main.async {
                        ...
                        if classificationResult == "zxsu"{
                            let alert = UIAlertController(title: "Hello", message: "Authentication Succeeded!", preferredStyle: .alert)
                            self.present(alert, animated: true, completion:  nil)
                        } else {
                            let alert = UIAlertController(title: "Sorry", message: "Try it again!", preferredStyle: .alert)
                            self.present(alert, animated: true, completion:  nil)
                        }
